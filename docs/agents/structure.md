...
- `src/ui/mobile/routes/` contains the Expo Router screens consumed by the mobile runtime in `mobile/`.
...
- `web/` contains the web package, Vite/Vitest/TypeScript config, Cloudflare Pages config, and shadcn config.
